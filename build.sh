...
gcc -o recv.x86 recv.c -lcelt0 -lao -lm
...
CFLAGS=" -march=armv4t -mtune=arm920t -Os" CXXFLAGS=" -march=armv4t -mtune=arm920t -Os" arm-linux-gcc -o recv.arm recv.c -L. -lao -lcelt0 -lm
